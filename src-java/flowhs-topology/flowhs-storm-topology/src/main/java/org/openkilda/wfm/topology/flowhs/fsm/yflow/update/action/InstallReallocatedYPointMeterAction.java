...
@Slf4j
public class InstallReallocatedYPointMeterAction
        extends YFlowProcessingAction<YFlowUpdateFsm, State, Event, YFlowUpdateContext> {
    public InstallReallocatedYPointMeterAction(PersistenceManager persistenceManager) {
    ...
    protected void perform(State from, State to, Event event, YFlowUpdateContext context, YFlowUpdateFsm stateMachine) {
        ...
        stateMachine.saveActionToHistory("Do not install because Rule Manger feature is not implemented yet");
