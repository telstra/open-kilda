...
public class OnFinishedWithErrorAction extends HistoryRecordingAction<
    ...
    public void perform(State from, State to, Event event, HaFlowSyncContext context, HaFlowSyncFsm stateMachine) {
        dashboardLogger.onFailedHaFlowSync(stateMachine.getHaFlowId(), stateMachine.getErrorReason());
        stateMachine.saveActionToHistory("Failed to sync the HA-flow", stateMachine.getErrorReason());
    }
}
