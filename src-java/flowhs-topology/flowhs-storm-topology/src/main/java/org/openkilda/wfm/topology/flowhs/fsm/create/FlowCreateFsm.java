...
public final class FlowCreateFsm extends NbTrackableFsm<FlowCreateFsm, State, Event, FlowCreateContext> {
    ...
    private FlowPathSnapshot forwardPath;
    private FlowPathSnapshot reversePath;
    private FlowPathSnapshot protectedForwardPath;
    private FlowPathSnapshot protectedReversePath;
