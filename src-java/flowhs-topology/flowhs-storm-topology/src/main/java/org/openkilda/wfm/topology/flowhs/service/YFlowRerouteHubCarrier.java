...
public interface YFlowRerouteHubCarrier extends FlowGenericCarrier {
    /**
     ...
     */
    void sendYFlowRerouteResultStatus(String flowId, RerouteError rerouteError, String correlationId);
}
