...
@Slf4j
public class SetInstallRuleErrorAction extends AnonymousAction<FlowRerouteFsm, State, Event, FlowRerouteContext> {
    ...
    public void execute(State from, State to, Event event, FlowRerouteContext context, FlowRerouteFsm stateMachine) {
        ...
        stateMachine.setRerouteError(new RuleFailedError("Failed to install rules", switches));
