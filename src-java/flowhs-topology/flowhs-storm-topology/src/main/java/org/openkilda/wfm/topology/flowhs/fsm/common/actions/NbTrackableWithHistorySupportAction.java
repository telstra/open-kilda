...
@Slf4j
public abstract class NbTrackableWithHistorySupportAction<T extends FlowProcessingWithHistorySupportFsm<T, S, E, C, ?,
        ?>, S, E, C> extends FlowProcessingWithHistorySupportAction<T, S, E, C> {
    protected NbTrackableWithHistorySupportAction(PersistenceManager persistenceManager) {
