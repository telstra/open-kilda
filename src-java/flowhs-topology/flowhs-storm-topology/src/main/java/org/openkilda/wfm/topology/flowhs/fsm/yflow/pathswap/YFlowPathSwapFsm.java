...
import org.openkilda.wfm.topology.flowhs.fsm.yflow.pathswap.actions.PrepareUpdateSharepointRulesAction;
import org.openkilda.wfm.topology.flowhs.fsm.yflow.pathswap.actions.RevertSharedpointRulesAction;
...
import org.openkilda.wfm.topology.flowhs.fsm.yflow.pathswap.actions.UpdateSharedpointRulesAction;
    ...
    public static class Factory {
        ...
        public Factory(@NonNull FlowGenericCarrier carrier, @NonNull PersistenceManager persistenceManager,
            ...
            builder.transition()
                    ...
                    .on(Event.NEXT)
                    .perform(new PrepareUpdateSharepointRulesAction(persistenceManager, ruleManager));
            ...
            builder.transition()
                    ...
                    .on(Event.NEXT)
                    .perform(new SwapYFlowResourcesAction(persistenceManager, ruleManager));
            ...
            builder.transition()
                    ...
                    .on(Event.NEXT)
                    .perform(new UpdateSharedpointRulesAction(persistenceManager, ruleManager));
            ...
            builder.transition()
                    ...
                    .on(Event.NEXT)
                    .perform(new RevertSharedpointRulesAction(persistenceManager, ruleManager));
