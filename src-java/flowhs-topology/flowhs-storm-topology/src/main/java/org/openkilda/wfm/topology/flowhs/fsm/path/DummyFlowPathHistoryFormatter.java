...
class DummyFlowPathHistoryFormatter extends FlowPathHistoryFormatter {
    private static final String ERROR_MESSAGE = "Dummy history formatter have been used";

    public DummyFlowPathHistoryFormatter() {
        super(null);
    }
