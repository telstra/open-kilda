...
@Slf4j
public class RemoveYPointMetersAction extends YFlowProcessingAction<YFlowUpdateFsm, State, Event, YFlowUpdateContext> {
    public RemoveYPointMetersAction(PersistenceManager persistenceManager) {
    ...
    protected void perform(State from, State to, Event event, YFlowUpdateContext context, YFlowUpdateFsm stateMachine) {
        ...
        //TODO: build and send new and old ypoint meter remove command
