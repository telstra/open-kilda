...
@Slf4j
public class OnFinishedAction extends HistoryRecordingAction<HaFlowSyncFsm, State, Event, HaFlowSyncContext> {
    ...
    @Override
    public void perform(State from, State to, Event event, HaFlowSyncContext context, HaFlowSyncFsm stateMachine) {
        dashboardLogger.onSuccessfulHaFlowSync(stateMachine.getHaFlowId());
        stateMachine.saveActionToHistory("HA-flow was synced successfully");
    }
}
