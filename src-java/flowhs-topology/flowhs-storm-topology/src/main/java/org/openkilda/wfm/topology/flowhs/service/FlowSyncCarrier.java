...
public interface FlowSyncCarrier extends FlowGenericCarrier {
    void launchFlowPathInstallation(
    ...
    void cancelFlowPathOperation(PathId pathId) throws UnknownKeyException;
}
