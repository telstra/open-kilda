...
@Slf4j
public class ValidateYPointMeterAction extends YFlowProcessingAction<YFlowCreateFsm, State, Event, YFlowCreateContext> {
    public ValidateYPointMeterAction(PersistenceManager persistenceManager) {
    ...
    protected void perform(State from, State to, Event event, YFlowCreateContext context, YFlowCreateFsm stateMachine) {
        ...
        //TODO: build and send a ypoint meter install command
        stateMachine.saveActionToHistory("No need to validate y-point meter");
