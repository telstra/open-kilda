...
@Slf4j
public class OnFinishedAction extends HistoryRecordingAction<YFlowPathSwapFsm, State, Event, YFlowPathSwapContext> {
    ...
    protected void perform(State from, State to, Event event, YFlowPathSwapContext context,
        ...
        dashboardLogger.onSuccessfulYFlowPathsSwap(stateMachine.getYFlowId());
        stateMachine.saveActionToHistory("Y-flow paths was swapped successfully");
    }
}
