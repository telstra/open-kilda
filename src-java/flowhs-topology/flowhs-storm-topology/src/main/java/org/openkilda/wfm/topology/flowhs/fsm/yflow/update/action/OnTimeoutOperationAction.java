...
@Slf4j
public class OnTimeoutOperationAction extends AnonymousAction<YFlowUpdateFsm, State, Event, YFlowUpdateContext> {

    @Override
    public final void execute(State from, State to, Event event, YFlowUpdateContext context,
