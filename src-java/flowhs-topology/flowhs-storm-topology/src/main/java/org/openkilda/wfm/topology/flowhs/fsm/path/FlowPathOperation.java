...
public interface FlowPathOperation {
    void handleSpeakerResponse(@NonNull SpeakerFlowSegmentResponse response);

    void handleCancel();

    FlowPathReference getPathReference();

    FlowPathResultCode getResultCode();

    CompletableFuture<FlowPathResult> getResultFuture();
}
