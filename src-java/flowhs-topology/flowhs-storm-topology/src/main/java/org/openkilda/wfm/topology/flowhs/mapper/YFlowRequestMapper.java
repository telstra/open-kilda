...
public abstract class YFlowRequestMapper {
    ...
    public PathComputationStrategy toComputationStrategy(String raw) {
        return raw != null ? PathComputationStrategy.valueOf(raw.toUpperCase()) : null;
    }
    ...
    public Collection<RequestedFlow> toRequestedFlows(YFlowRequest request) {
        return request.getSubFlows().stream()
                .map(subFlow -> RequestedFlow.builder()
                        ...
                        .flowEncapsulationType(map(request.getEncapsulationType()))
                        ...
                        .pathComputationStrategy(toComputationStrategy(request.getPathComputationStrategy()))
