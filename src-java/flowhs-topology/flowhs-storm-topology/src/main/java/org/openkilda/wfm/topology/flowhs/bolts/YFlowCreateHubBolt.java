...
public class YFlowCreateHubBolt extends HubBolt
    ...
    public YFlowCreateHubBolt(YFlowCreateConfig yflowCreateConfig, FlowCreateConfig flowCreateConfig,
        ...
        enableMeterRegistry("kilda.yflow_create", HUB_TO_METRICS_BOLT.name());
    }
    ...
    protected boolean deactivate(LifecycleEvent event) {
        if (yflowCreateService.deactivate() && flowCreateService.deactivate()) {
            return true;
        }
    ...
    protected void activate() {
        flowCreateService.deactivate();
        yflowCreateService.deactivate();
    }
    ...
    protected void onRequest(Tuple input) throws PipelineException {
        ...
        yflowCreateService.handleRequest(currentKey, pullContext(input), payload);
    }
    ...
    protected void onWorkerResponse(Tuple input) throws PipelineException {
        ...
        flowCreateService.handleAsyncResponse(currentKey, flowResponse);
    ...
    public void onTimeout(String key, Tuple tuple) {
        currentKey = key;
        flowCreateService.handleTimeout(key);
