...
@Slf4j
public class PrepareUpdateSharepointRulesAction extends
        YFlowRuleManagerProcessingAction<YFlowPathSwapFsm, State, Event, YFlowPathSwapContext> {
    public PrepareUpdateSharepointRulesAction(PersistenceManager persistenceManager, RuleManager ruleManager) {
