...
public class FlowOperationsServiceTest extends Neo4jBasedTest {
    ...
    private Flow createFlow(String flowId, Switch srcSwitch, int srcPort, Switch dstSwitch, int dstPort,
        ...
        FlowPath forwardPath = FlowPath.builder()
                ...
                .srcSwitch(srcSwitch)
                .destSwitch(dstSwitch)
                .cookie(FlowSegmentCookieSchema.INSTANCE.make(UNMASKED_COOKIE, FlowPathDirection.FORWARD))
                .build();
        ...
        FlowPath reversePath = FlowPath.builder()
                ...
                .cookie(FlowSegmentCookieSchema.INSTANCE.make(UNMASKED_COOKIE, FlowPathDirection.REVERSE))
                .build();
