...
public class NetworkWatchListServiceTest {
    ...
    @org.junit.Test
    public void enableSlowDiscoveryFlags() {
        NetworkWatchListService s = new NetworkWatchListService(carrier, 10, 20, 30);
        ...
        s.updateSlowDiscoveryFlag(Endpoint.of(new SwitchId(2), 2), true);
        s.updateBfdSlowDiscoveryFlag(Endpoint.of(new SwitchId(3), 3), true);
    ...
    @org.junit.Test
    public void disableSlowDiscoveryFlags() {
        ...
        s.updateSlowDiscoveryFlag(Endpoint.of(new SwitchId(2), 2), true);
        s.updateSlowDiscoveryFlag(Endpoint.of(new SwitchId(3), 3), true);
        s.updateBfdSlowDiscoveryFlag(Endpoint.of(new SwitchId(3), 3), true);
        ...
        s.updateSlowDiscoveryFlag(Endpoint.of(new SwitchId(2), 2), false);
        s.updateBfdSlowDiscoveryFlag(Endpoint.of(new SwitchId(3), 3), false, i);
        ...
        verify(carrier, times(10)).discoveryRequest(eq(Endpoint.of(new SwitchId(1), 1)),
                longThat(time -> Arrays.asList(1L, 11L, 21L, 31L, 41L, 51L, 61L, 71L, 81L, 91L).contains(time)));
        verify(carrier, times(8)).discoveryRequest(eq(Endpoint.of(new SwitchId(2), 2)),
                longThat(time -> Arrays.asList(1L, 11L, 26L, 41L, 56L, 71L, 81L, 91L).contains(time)));
