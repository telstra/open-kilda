...
public class NetworkOptions implements Serializable {
    ...
    private Long slowDiscoveryInterval;

    private Long bfdSlowDiscoveryInterval;
    ...
    public NetworkOptions(NetworkTopologyConfig topologyConfig) {
        ...
        slowDiscoveryInterval = TimeUnit.SECONDS.toNanos(topologyConfig.getSlowDiscoveryInterval());
        bfdSlowDiscoveryInterval = TimeUnit.SECONDS.toNanos(topologyConfig.getBfdSlowDiscoveryInterval());
