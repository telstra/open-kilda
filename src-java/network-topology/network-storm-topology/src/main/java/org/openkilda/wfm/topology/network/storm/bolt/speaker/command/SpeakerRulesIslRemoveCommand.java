...
public class SpeakerRulesIslRemoveCommand extends SpeakerRulesWorkerCommand {
    Endpoint source;
    Endpoint destination;

    public SpeakerRulesIslRemoveCommand(String key, Endpoint source, Endpoint destination) {
        super(key);
        this.source = source;
