...
public class IslDefaultRuleRemovedCommand extends IslCommand {
    private final RemoveIslDefaultRulesResult payload;

    public IslDefaultRuleRemovedCommand(RemoveIslDefaultRulesResult payload) {
    ...
    public void apply(IslHandler handler) {
        handler.processIslRuleDeleted(getReference(), payload);
    }
}
