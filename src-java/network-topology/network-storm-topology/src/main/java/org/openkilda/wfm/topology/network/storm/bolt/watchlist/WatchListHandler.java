...
public class WatchListHandler extends AbstractBolt implements IWatchListCarrier {
    ...
    protected void init() {
        service = new NetworkWatchListService(this, options.getDiscoveryInterval(),
                options.getSlowDiscoveryInterval(), options.getBfdSlowDiscoveryInterval());
    }
    ...
    public void processUpdateSlowDiscoveryFlag(Endpoint endpoint, boolean isEnabled) {
        service.updateSlowDiscoveryFlag(endpoint, isEnabled);
    }

    public void processUpdateBfdSlowDiscoveryFlag(Endpoint endpoint, boolean isEnabled) {
        service.updateBfdSlowDiscoveryFlag(endpoint, isEnabled);
    }
}
