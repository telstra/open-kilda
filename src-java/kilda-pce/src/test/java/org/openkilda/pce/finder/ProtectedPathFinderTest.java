...
public class ProtectedPathFinderTest {
    ...
    public void shouldFindProtectedPath() throws RecoverableException, UnroutableFlowException {
        ...
        assertAll(
                ...
                () -> assertThat(firstSegment.getDestSwitchId(), equalTo(switchD.getSwitchId()))
        );
    ...
    @Test
    public void shouldFindDegradedProtectedPath() throws RecoverableException, UnroutableFlowException {
        // Topology:
        //     D-----E
        //   /       |
        // A----B----C     Already created flow: A-B-C
        ...
        flow.setForwardPath(forwardPath);
        flow.setReversePath(reversePath);
        flow.setMaxLatency(1L);
        flow.setMaxLatencyTier2(100L);
        ...
        assertThat(path.isBackUpPathComputationWayUsed(), is(true));
    }
