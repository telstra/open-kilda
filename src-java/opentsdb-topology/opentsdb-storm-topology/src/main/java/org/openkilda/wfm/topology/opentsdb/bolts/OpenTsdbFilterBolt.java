...
import static org.openkilda.wfm.topology.opentsdb.OpenTsdbTopology.DATAPOINT_STREAM;
...
public class OpenTsdbFilterBolt extends AbstractBolt implements DatapointCarrier {
    ...
    public OpenTsdbFilterBolt(String lifeCycleEventSourceComponent) {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream(DATAPOINT_STREAM, DECLARED_FIELDS);
