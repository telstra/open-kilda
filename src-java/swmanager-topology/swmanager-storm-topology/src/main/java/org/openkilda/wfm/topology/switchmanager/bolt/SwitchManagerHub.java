...
import org.openkilda.wfm.topology.switchmanager.service.impl.fsmhandlers.CreateLagServiceImpl;
...
public class SwitchManagerHub extends HubBolt implements SwitchManagerCarrier {
    ...
    private transient CreateLagService createLagService;
    ...
    public void init() {
        ...
        createLagService = new CreateLagServiceImpl(this, persistenceManager.getRepositoryFactory(),
    ...
    protected void onRequest(Tuple input) throws PipelineException {
        ...
        } else if (data instanceof CreateLagRequest) {
            createLagService.handleCreateLagRequest(key, (CreateLagRequest) data);
        } else {
    ...
    protected void onWorkerResponse(Tuple input) throws PipelineException {
        ...
        if (message instanceof InfoMessage) {
            ...
            if (data instanceof SwitchFlowEntries) {
                ...
                createLagService.handleGrpcResponse(key, (CreateLogicalPortResponse) data);
            } else {
            ...
            createLagService.handleTaskError(key, (ErrorMessage) message);
        }
    }
    ...
    public void sendInactive() {
        if (validateService.isAllOperationsCompleted()
                ...
                && createLagService.isAllOperationsCompleted()) {
