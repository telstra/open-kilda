...
public class CommandBuilderImplTest {
        ...
        List<BaseInstallFlow> response = commandBuilder
                .buildCommandsToSyncMissingRules(SWITCH_ID_B,
                        Stream.of(1L, 2L, 3L, 4L)
                                .map(effectiveId -> FlowSegmentCookieSchema.INSTANCE.make(
                                        effectiveId, FlowPathDirection.FORWARD))
                                .map(Cookie::getValue)
    ...
    private static class PersistenceManagerBuilder {
        ...
        private FlowPath buildFlowAndPath(String flowId, SwitchId srcSwitchId, SwitchId destSwitchId,
            ...
            FlowPath forwardPath = FlowPath.builder()
                    ...
                    .cookie(FlowSegmentCookieSchema.INSTANCE.make(cookie, FlowPathDirection.FORWARD))
                    .segments(emptyList())
                    .build();
            FlowPath reversePath = FlowPath.builder()
                    ...
                    .cookie(FlowSegmentCookieSchema.INSTANCE.make(cookie, FlowPathDirection.REVERSE))
                    .segments(emptyList())
                    .build();
    ...
    public void shouldBuildRemoveFlowWithoutMeterFromFlowEntryWithTransitVlanEncapsulation() {
        Long cookie = FlowSegmentCookieSchema.INSTANCE.make(1, FlowPathDirection.FORWARD).getValue();
        String inPort = "1";
        String inVlan = "10";
        String outPort = "2";
