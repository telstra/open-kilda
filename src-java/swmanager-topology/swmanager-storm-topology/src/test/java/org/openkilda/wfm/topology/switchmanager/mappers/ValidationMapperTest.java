...
public class ValidationMapperTest {
    ...
    private GroupSpeakerData initializeGroupSpeakerData(SwitchId uniqueSwitchIdField) {
    ...
    private FlowSpeakerData initializeFlowSpeakerData(int uniquePriorityField) {
    ...
    private MeterSpeakerData initializeMeterSpeakerData(MeterId uniqueMeterIdValue) {
    ...
    private LagLogicalPort initializeLogicalPortData(SwitchId uniqueSwitchIdField) {
        return new LagLogicalPort(uniqueSwitchIdField, LAG_PORT,
                Lists.newArrayList(PHYSICAL_PORT_1, PHYSICAL_PORT_2));
    }

    List<GroupInfoEntry> missingGroups = new LinkedList<>();
    List<GroupInfoEntry> properGroups = new LinkedList<>();
    List<GroupInfoEntry> excessGroups = new LinkedList<>();
    List<GroupInfoEntry> misconfiguredGroups = new LinkedList<>();
    ...
    List<MeterInfoEntry> missingMeters = new LinkedList<>();
    List<MeterInfoEntry> misconfiguredMeters = new LinkedList<>();
    List<MeterInfoEntry> properMeters = new LinkedList<>();
    List<MeterInfoEntry> excessMeters = new LinkedList<>();
    List<LogicalPortInfoEntry> properPorts = new LinkedList<>();
    List<LogicalPortInfoEntry> missingPorts = new LinkedList<>();
    List<LogicalPortInfoEntry> excessPorts = new LinkedList<>();
    List<LogicalPortInfoEntry> misconfiguredPorts = new LinkedList<>();

    ValidateGroupsResult groupsResult;
    ValidateRulesResult rulesResult;
    ValidateMetersResult metersResult;
    ValidateLogicalPortsResult logicalPortsResult;
