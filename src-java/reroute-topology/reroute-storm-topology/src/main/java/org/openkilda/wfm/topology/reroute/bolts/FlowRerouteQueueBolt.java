...
public class FlowRerouteQueueBolt extends CoordinatedBolt implements IRerouteQueueCarrier {
    ...
    public static final String BOLT_ID_REROUTE_QUEUE = "reroute-queue-bolt";
    ...
    protected void handleInput(Tuple tuple) {
        ...
        if (sourceComponent.equals(TimeWindowBolt.BOLT_ID_TIME_WINDOW)) {
            rerouteQueueService.flushThrottling();
        } else if (sourceComponent.equals(RerouteBolt.BOLT_ID_REROUTE)) {
            String flowId = tuple.getStringByField(RerouteBolt.FLOW_ID_FIELD);
            ...
            switch (tuple.getSourceStreamId()) {
                case STREAM_REROUTE_RESULT_ID:
                    RerouteResultInfoData rerouteResultInfoData =
                            (RerouteResultInfoData) tuple.getValueByField(RerouteBolt.REROUTE_RESULT_FIELD);
                    rerouteQueueService.processRerouteResult(flowId, rerouteResultInfoData,
                ...
                case STREAM_REROUTE_REQUEST_ID:
                    ...
                    rerouteQueueService.putRequestToThrottling(flowId, throttlingData);
                    break;
