...
/**
 * Class represents client error message.
 */
@JsonSerialize
...
@JsonPropertyOrder(value = {
        ...
        TIMESTAMP,
        CORRELATION_ID})
public class ClientErrorMessage extends ErrorMessage {

    /**
     * Data of the client error message.
     */
     ...
     */
    @JsonCreator
    public ClientErrorMessage(@JsonProperty(PAYLOAD) final ErrorData data,
