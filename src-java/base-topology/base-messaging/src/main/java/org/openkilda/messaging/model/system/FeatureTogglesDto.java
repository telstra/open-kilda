...
public class FeatureTogglesDto implements Serializable {
    ...
    @JsonProperty("cud_on_yflow_enabled")
    private Boolean cudOnYFlowEnabled;
    ...
    public FeatureTogglesDto(@JsonProperty("flows_reroute_on_isl_discovery") Boolean flowsRerouteOnIslDiscoveryEnabled,
                             ...
                             @JsonProperty("cud_on_yflow_enabled") Boolean cudOnYFlowEnabled) {
        ...
        this.cudOnYFlowEnabled = cudOnYFlowEnabled;
    }
}
