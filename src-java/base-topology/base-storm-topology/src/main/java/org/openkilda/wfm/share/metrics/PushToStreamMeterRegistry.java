...
/**
 * Implementation of {@code MeterRegistry} that provides meters (counter, timer, gauge) and
 * ability to push the statistics into a Storm stream.
 * <br/>
 * The registry resets timer data on pushing statistics. See {@code ResettableTimer}.
 * <br/>
 * <strong>NOTE:</strong> {@code DistributionSummary}, {@code FunctionTimer}, {@code FunctionCounter},
 *     {@code DistributionSummary} are not supported yet.
 */
@Slf4j
