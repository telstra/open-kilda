...
public interface IRouterCarrier {
    ...
    void activateIslMonitoringOnSwitch(SwitchId switchId);

    void deactivateIslMonitoringOnSwitch(SwitchId switchId);

    void syncIslsOnSwitch(SwitchId switchId);
}
