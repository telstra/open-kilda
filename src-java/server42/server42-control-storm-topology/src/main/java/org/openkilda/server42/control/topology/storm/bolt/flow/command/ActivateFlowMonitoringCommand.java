...
public class ActivateFlowMonitoringCommand extends FlowCommand {

    private final boolean isForward;
    private final ActivateFlowMonitoringInfoData data;

    public ActivateFlowMonitoringCommand(ActivateFlowMonitoringInfoData data, boolean isForward) {
        super(isForward ? data.getSource().getDatapath() : data.getDestination().getDatapath());
