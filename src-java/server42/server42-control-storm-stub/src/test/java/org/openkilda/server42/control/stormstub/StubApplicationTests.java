...
class StubApplicationTests {
    ...
    private final AddFlowPayload testFlowVxlan2002 = AddFlowPayload.builder()
            .flowId("TestFlowVxlan2002").encapsulationType(EncapsulationType.VXVLAN).tunnelId(2002L).build();
    private final AddFlowPayload testFlowVxlan3003 = AddFlowPayload.builder()
            .flowId("testFlowVxlan3003").encapsulationType(EncapsulationType.VXVLAN).tunnelId(3003L).build();
