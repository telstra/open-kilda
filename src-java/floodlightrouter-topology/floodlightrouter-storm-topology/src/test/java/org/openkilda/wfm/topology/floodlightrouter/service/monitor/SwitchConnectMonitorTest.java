...
public abstract class SwitchConnectMonitorTest {
    ...
    protected abstract SwitchConnectMonitor makeSubject(SwitchId switchId);
    ...
    protected abstract SwitchInfoData makeConnectNotification(SwitchId switchId);

    protected abstract SwitchInfoData makeDisconnectNotification(SwitchId switchId);
}
