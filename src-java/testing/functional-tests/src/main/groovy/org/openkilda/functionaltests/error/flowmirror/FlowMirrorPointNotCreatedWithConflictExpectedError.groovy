...
class FlowMirrorPointNotCreatedWithConflictExpectedError extends AbstractExpectedError{
    final static HttpStatus statusCode = HttpStatus.CONFLICT
    final static String message = "Could not create flow mirror point"

    FlowMirrorPointNotCreatedWithConflictExpectedError(Pattern descriptionPattern) {
