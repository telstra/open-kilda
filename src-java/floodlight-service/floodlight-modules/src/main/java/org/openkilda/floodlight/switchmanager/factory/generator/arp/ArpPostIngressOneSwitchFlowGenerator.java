...
public class ArpPostIngressOneSwitchFlowGenerator extends ArpFlowGenerator {

    @Builder
    public ArpPostIngressOneSwitchFlowGenerator(FeatureDetectorService featureDetectorService,
