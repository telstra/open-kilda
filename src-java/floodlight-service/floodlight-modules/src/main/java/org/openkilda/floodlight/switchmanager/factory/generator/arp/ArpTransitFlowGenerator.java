...
public class ArpTransitFlowGenerator extends ArpFlowGenerator {

    @Builder
    public ArpTransitFlowGenerator(FeatureDetectorService featureDetectorService, SwitchManagerConfig config) {
