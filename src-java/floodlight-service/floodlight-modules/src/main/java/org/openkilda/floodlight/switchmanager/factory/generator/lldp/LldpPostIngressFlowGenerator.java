...
public class LldpPostIngressFlowGenerator extends LldpFlowGenerator {

    @Builder
    public LldpPostIngressFlowGenerator(FeatureDetectorService featureDetectorService, SwitchManagerConfig config) {
