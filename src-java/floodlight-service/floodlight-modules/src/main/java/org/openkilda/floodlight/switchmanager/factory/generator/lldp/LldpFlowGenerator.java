...
public abstract class LldpFlowGenerator extends MeteredFlowGenerator {
    ...
    public LldpFlowGenerator(FeatureDetectorService featureDetectorService, SwitchManagerConfig config) {
        super(featureDetectorService, config);
    }

    abstract OFFlowMod getLldpFlowMod(IOFSwitch sw, OFInstructionMeter meter,
