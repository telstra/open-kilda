...
public class IngressFlowSegmentInstallFlowModFactory extends IngressFlowSegmentInstallFlowModFactoryBase {
    public IngressFlowSegmentInstallFlowModFactory(
            IngressFlowSegmentCommand command, IOFSwitch sw, Set<SwitchFeature> features) {
        super(new OfFlowModAddMessageBuilderFactory(SwitchManager.FLOW_PRIORITY), command, sw, features);
    }
}
