...
public class IngressMirrorFlowSegmentInstallRequest extends IngressFlowSegmentRequest {
    @JsonCreator
    @Builder(toBuilder = true)
    public IngressMirrorFlowSegmentInstallRequest(
    ...
    public IngressMirrorFlowSegmentInstallRequest(IngressFlowSegmentRequest other, UUID commandId) {
