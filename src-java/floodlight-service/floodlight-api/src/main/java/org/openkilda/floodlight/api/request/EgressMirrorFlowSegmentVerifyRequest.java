...
public class EgressMirrorFlowSegmentVerifyRequest extends EgressFlowSegmentRequest {
    @JsonCreator
    @Builder(toBuilder = true)
    public EgressMirrorFlowSegmentVerifyRequest(
    ...
    public EgressMirrorFlowSegmentVerifyRequest(EgressFlowSegmentRequest other, UUID commandId) {
