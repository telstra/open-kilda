...
public class IngressFlowLoopSegmentRemoveRequest extends IngressFlowSegmentRequest {
    @JsonCreator
    ...
    public IngressFlowLoopSegmentRemoveRequest(IngressFlowSegmentRequest other, UUID commandId) {
