...
public class DeleteRulesCriteria implements Serializable {
    ...
    public DeleteRulesCriteria(
            ...
            @JsonProperty("metadata_value") Long metadataValue,
            @JsonProperty("metadata_mask") Long metadataMask) {
        if ((cookie == null || cookie == 0)
                ...
                && (egressSwitchId == null)
                && (metadataValue == null || metadataValue == 0)
                && (metadataMask == null || metadataMask == 0)) {
