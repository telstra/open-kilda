...
public class IngressFlowLoopSegmentVerifyRequest extends IngressFlowSegmentRequest {
    @JsonCreator
    ...
    public IngressFlowLoopSegmentVerifyRequest(IngressFlowSegmentRequest other, UUID commandId) {
