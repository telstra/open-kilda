...
public class InstallServer42IngressFlow extends InstallTransitFlow {
    ...
    public void setInputVlanId(final Integer inputVlanId) {
        this.inputVlanId = adaptVlanId(inputVlanId);
    }

    public void setInputInnerVlanId(final Integer inputInnerVlanId) {
        this.inputInnerVlanId = adaptVlanId(inputInnerVlanId);
    }
}
