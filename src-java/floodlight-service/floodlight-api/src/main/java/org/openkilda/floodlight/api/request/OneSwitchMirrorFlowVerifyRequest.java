...
public class OneSwitchMirrorFlowVerifyRequest extends OneSwitchFlowRequest {
    @JsonCreator
    @Builder(toBuilder = true)
    public OneSwitchMirrorFlowVerifyRequest(
    ...
    public OneSwitchMirrorFlowVerifyRequest(OneSwitchFlowRequest other, UUID commandId) {
