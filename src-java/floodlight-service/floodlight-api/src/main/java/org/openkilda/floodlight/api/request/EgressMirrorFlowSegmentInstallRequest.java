...
public class EgressMirrorFlowSegmentInstallRequest extends EgressFlowSegmentRequest {

    @JsonCreator
    @Builder(toBuilder = true)
    public EgressMirrorFlowSegmentInstallRequest(
    ...
    public EgressMirrorFlowSegmentInstallRequest(EgressFlowSegmentRequest other, UUID commandId) {
