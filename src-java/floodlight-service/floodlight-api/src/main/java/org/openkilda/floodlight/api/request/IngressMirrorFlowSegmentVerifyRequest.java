...
public class IngressMirrorFlowSegmentVerifyRequest extends IngressFlowSegmentRequest {
    @JsonCreator
    @Builder(toBuilder = true)
    public IngressMirrorFlowSegmentVerifyRequest(
    ...
    public IngressMirrorFlowSegmentVerifyRequest(IngressFlowSegmentRequest other, UUID commandId) {
