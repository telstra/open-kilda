...
public class EgressMirrorFlowSegmentRemoveRequest extends EgressFlowSegmentRequest {
    @JsonCreator
    @Builder(toBuilder = true)
    public EgressMirrorFlowSegmentRemoveRequest(
    ...
    public EgressMirrorFlowSegmentRemoveRequest(EgressFlowSegmentRequest other, UUID commandId) {
