...
public class EgressFlowSegmentVerifyRequest extends EgressFlowSegmentRequest {
    @JsonCreator
    @Builder(toBuilder = true)
    public EgressFlowSegmentVerifyRequest(
    ...
    public EgressFlowSegmentVerifyRequest(EgressFlowSegmentRequest other, UUID commandId) {
