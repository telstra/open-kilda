...
public class InstallTransitLoopFlow extends InstallEgressFlow {
    /**
     ...
     */
    @JsonCreator
    public InstallTransitLoopFlow(@JsonProperty(TRANSACTION_ID) final UUID transactionId,
    ...
    public boolean equals(Object object) {
        ...
        InstallTransitLoopFlow that = (InstallTransitLoopFlow) object;
