...
import org.openkilda.floodlight.api.request.IngressMirrorFlowSegmentInstallRequest;
import org.openkilda.floodlight.api.request.IngressMirrorFlowSegmentRemoveRequest;
import org.openkilda.floodlight.api.request.IngressMirrorFlowSegmentVerifyRequest;
...
public class IngressMirrorFlowSegmentRequestFactory extends FlowSegmentRequestFactory {
    ...
    public IngressFlowSegmentRequest makeInstallRequest(UUID commandId) {
        return new IngressMirrorFlowSegmentInstallRequest(requestBlank, commandId);
    }

    @Override
    public IngressFlowSegmentRequest makeRemoveRequest(UUID commandId) {
        return new IngressMirrorFlowSegmentRemoveRequest(requestBlank, commandId);
    }

    @Override
    public IngressFlowSegmentRequest makeVerifyRequest(UUID commandId) {
        return new IngressMirrorFlowSegmentVerifyRequest(requestBlank, commandId);
    }
