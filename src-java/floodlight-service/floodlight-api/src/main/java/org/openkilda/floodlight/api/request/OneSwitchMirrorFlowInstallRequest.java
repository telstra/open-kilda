...
public class OneSwitchMirrorFlowInstallRequest extends OneSwitchFlowRequest {
    @JsonCreator
    @Builder(toBuilder = true)
    public OneSwitchMirrorFlowInstallRequest(
        ...
        super(messageContext, commandId, metadata, endpoint, meterConfig, egressEndpoint, rulesContext, mirrorConfig,
                statVlans);
    }

    public OneSwitchMirrorFlowInstallRequest(OneSwitchFlowRequest other, UUID commandId) {
