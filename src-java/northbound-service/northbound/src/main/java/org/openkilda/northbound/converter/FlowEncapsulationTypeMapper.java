...
public abstract class FlowEncapsulationTypeMapper {
    /**
    ...
    /**
     * Convert {@link org.openkilda.model.FlowEncapsulationType} to {@link String}.
     */
    public String map(org.openkilda.model.FlowEncapsulationType encapsulationType) {
        if (encapsulationType == null) {
            return null;
        }
     ...
     */
    public FlowEncapsulationType mapToEncapsulationTypeDto(String encapsulationType) {
        if (encapsulationType == null) {
            return null;
        }
     ...
     */
    public org.openkilda.model.FlowEncapsulationType mapToEncapsulationType(String encapsulationType) {
        if (encapsulationType == null) {
            return null;
        }
