...
public class SwitchMapperTest {
    ...
    public void testToGroupInfoDtoV1() {
        CopyFieldActionEntry a = CopyFieldActionEntry.builder().build();
        a.getActionType();
    ...
    private void assertActions(CopyFieldActionEntry expectedAction, CopyFieldActionDto actualAction) {
        ...
        assertEquals(expectedAction.getDstHeader(), actualAction.getDstHeader());
        assertEquals(expectedAction.getSrcHeader(), actualAction.getSrcHeader());
    }
    ...
    private List<BaseAction> buildActions() {
        ...
        baseActions.add(CopyFieldActionEntry.builder()
                .dstOffset(100)
                .numberOfBits(200)
                .dstHeader("oxmDstHeader")
                .srcHeader("oxmSrcHeader")
                .build());
        return baseActions;
    }
