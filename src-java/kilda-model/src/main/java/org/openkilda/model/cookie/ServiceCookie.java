...
public class ServiceCookie extends CookieBase implements Comparable<ServiceCookie> {
    ...
    public enum ServiceCookieTag implements NumericEnumField {
        ...
        PRE_INGRESS_PASS_THROUGH_COOKIE(0x08),
        INGRESS_DROP_COOKIE(0x09),
        POST_INGRESS_DROP_COOKIE(0x0A),
        EGRESS_PASS_THROUGH_COOKIE(0x0B),
        TRANSIT_DROP_COOKIE(0x0C),
        ...
        SERVER_42_FLOW_RTT_OUTPUT_VLAN_COOKIE(0x19),
        SERVER_42_FLOW_RTT_OUTPUT_VXLAN_COOKIE(0x1A),
        SERVER_42_FLOW_RTT_TURNING_COOKIE(0x1B),
        SERVER_42_ISL_RTT_OUTPUT_COOKIE(0x1C),
