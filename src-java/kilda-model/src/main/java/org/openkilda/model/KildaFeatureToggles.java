...
public class KildaFeatureToggles implements CompositeDataEntity<KildaFeatureTogglesData> {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder()
                ...
                .append(getCreateHaFlowEnabled(), that.getCreateHaFlowEnabled())
                .append(getModifyHaFlowEnabled(), that.getModifyHaFlowEnabled())
    ...
    public int hashCode() {
        return Objects.hash(getFlowsRerouteOnIslDiscoveryEnabled(), getCreateFlowEnabled(),
                ...
                getCreateHaFlowEnabled(), getModifyHaFlowEnabled(),
    ...
    public interface KildaFeatureTogglesData {
        ...
        Boolean getCreateHaFlowEnabled();

        void setCreateHaFlowEnabled(Boolean createHaFlowEnabled);
    ...
    public interface FeatureTogglesCloner {
        ...
        default void replaceNullProperties(KildaFeatureToggles source, KildaFeatureToggles target) {
            ...
            if (target.getCreateHaFlowEnabled() == null) {
                target.setCreateHaFlowEnabled(source.getCreateHaFlowEnabled());
            }
