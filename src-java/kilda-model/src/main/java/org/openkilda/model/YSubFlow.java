...
public class YSubFlow implements CompositeDataEntity<YSubFlowData> {
    ...
    @Builder
    public YSubFlow(@NonNull YFlow yFlow, @NonNull Flow subFlow, int sharedEndpointVlan, int sharedEndpointInnerVlan,
        ...
        YSubFlowDataImpl.YSubFlowDataImplBuilder builder = YSubFlowDataImpl.builder()
                .yFlow(yFlow).subFlow(subFlow).sharedEndpointVlan(sharedEndpointVlan)
    ...
    public interface YSubFlowCloner {
        ...
        @Mapping(target = "subFlow", ignore = true)
        ...
        default YSubFlowData deepCopy(YSubFlowData source, YFlow targetFlow) {
            ...
            result.setSubFlow(new Flow(source.getSubFlow()));
            return result;
        }
    }
}
