...
/**
 * Converter to convert {@link ConnectedDeviceType} to {@link String} and back.
 */
public class ConnectedDeviceTypeConverter implements AttributeConverter<ConnectedDeviceType, String> {
    public static final ConnectedDeviceTypeConverter INSTANCE = new ConnectedDeviceTypeConverter();
