...
/**
 * Represents update path info for HA-flow.
 */
@Value
@EqualsAndHashCode(callSuper = true)
@JsonNaming(value = SnakeCaseStrategy.class)
@ToString(callSuper = true)
public class UpdateHaFlowPathInfo extends BaseHaFlowPathInfo {
    private static final long serialVersionUID = 1L;

    @JsonCreator
    public UpdateHaFlowPathInfo(@NonNull @JsonProperty("ha_flow_id") String haFlowId,
