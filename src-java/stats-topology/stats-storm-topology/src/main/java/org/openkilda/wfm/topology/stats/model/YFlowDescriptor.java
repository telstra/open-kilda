...
public class YFlowDescriptor extends KildaEntryDescriptor {
    @NonNull String yFlowId;

    @NonNull MeterId meterId;

    public YFlowDescriptor(
            @NonNull SwitchId switchId, @NonNull MeasurePoint measurePoint, @NonNull String yFlowId,
            @NonNull MeterId meterId) {
