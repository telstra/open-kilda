...
import org.openkilda.floodlight.api.request.command.MeterInstallCommand;
...
public class OfSpeakerInstallCommandAdapter extends OfSpeakerCommandAdapterBase {
    ...
    public static SpeakerCommandsBatchRequest adaptBatch(
        ...
        return OfSpeakerCommandAdapterBase.newBatchRequest(
                new OfSpeakerInstallCommandAdapter(messageContext), commandId, speakerEntries);
    }

    protected OfSpeakerInstallCommandAdapter(MessageContext messageContext) {
    ...
    public void handle(MeterSpeakerCommandData meter) {
        entries.add(new MeterInstallCommand(messageContext, meter));
    }
