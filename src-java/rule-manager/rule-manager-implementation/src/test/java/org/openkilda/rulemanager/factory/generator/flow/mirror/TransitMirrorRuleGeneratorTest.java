...
public class TransitMirrorRuleGeneratorTest {
    ...
    public static final FlowMirrorPath PATH = FlowMirrorPath.builder()
    ...
    @Test
    public void buildCorrectVlanMultiTableTransitMirrorRuleTest() {
        TransitMirrorRuleGenerator generator = buildGenerator(PATH, VLAN_ENCAPSULATION);
        List<SpeakerData> commands = generator.generateCommands(SWITCH_1);
        assertTransitCommands(commands, VLAN_ENCAPSULATION);
    }

    @Test
    public void buildCorrectVxlanMultiTableTransitMirrorRuleTest() {
        TransitMirrorRuleGenerator generator = buildGenerator(PATH, VXLAN_ENCAPSULATION);
        List<SpeakerData> commands = generator.generateCommands(SWITCH_1);
    ...
    @Test
    public void buildOneSwitchFlowTransitMirrorRuleTest() {
    ...
    private static TransitMirrorRuleGenerator buildGenerator(
            FlowMirrorPath path, FlowTransitEncapsulation encapsulation) {
