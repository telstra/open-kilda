...
public class InputArpRuleGeneratorTest {
    ...
    public void buildCorrectRuleForOf13Test() {
        ...
        FlowSideAdapter overlapAdapter = new FlowSourceAdapter(Flow.builder()
                ...
                .detectConnectedDevices(DetectConnectedDevices.builder().srcArp(false).srcSwitchArp(false).build())
                .build());
    ...
    public void buildArpRuleWithOverlappedEndpointsTest() {
        ...
        FlowSideAdapter adapter = new FlowSourceAdapter(Flow.builder()
                ...
                .srcSwitch(SW)
                .destSwitch(buildSwitch("OF_13", Collections.emptySet()))
                .detectConnectedDevices(DetectConnectedDevices.builder().srcArp(true).srcSwitchArp(true).build())
                .build());
        InputArpRuleGenerator generator = InputArpRuleGenerator.builder()
                .ingressEndpoint(endpoint)
                .multiTable(true)
