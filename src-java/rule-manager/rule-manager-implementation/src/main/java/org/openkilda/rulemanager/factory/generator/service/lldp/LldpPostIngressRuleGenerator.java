...
public class LldpPostIngressRuleGenerator extends LldpRuleGenerator {

    @Builder
    public LldpPostIngressRuleGenerator(RuleManagerConfig config) {
        super(config);
    }
    ...
    public List<SpeakerData> generateCommands(Switch sw) {
        ...
        return buildCommands(sw, cookie, OfTable.POST_INGRESS, Priority.LLDP_POST_INGRESS_PRIORITY,
                match, instructions);
    }
}
