...
@SuperBuilder
@Slf4j
public class IngressRuleGenerator extends BaseIngressRuleGenerator {

    /*
     * This set must contain FlowSideAdapters which have same SwitchId and inPort as ingress
