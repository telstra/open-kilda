...
public class LldpIngressRuleGenerator extends LldpRuleGenerator {

    @Builder
    public LldpIngressRuleGenerator(RuleManagerConfig config) {
        super(config);
    }
    ...
    public List<SpeakerData> generateCommands(Switch sw) {
        ...
        Cookie cookie = new Cookie(LLDP_INGRESS_COOKIE);
        return buildCommands(sw, cookie, OfTable.INGRESS, Priority.LLDP_INGRESS_PRIORITY, match, instructions);
    }
}
