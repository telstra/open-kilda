...
public class ArpPostIngressOneSwitchRuleGenerator extends ArpRuleGenerator {

    @Builder
    public ArpPostIngressOneSwitchRuleGenerator(RuleManagerConfig config) {
        super(config);
    }
    ...
    public List<SpeakerData> generateCommands(Switch sw) {
        ...
        return buildCommands(sw, cookie, OfTable.POST_INGRESS, Priority.ARP_POST_INGRESS_ONE_SWITCH_PRIORITY,
                match, instructions);
    }
