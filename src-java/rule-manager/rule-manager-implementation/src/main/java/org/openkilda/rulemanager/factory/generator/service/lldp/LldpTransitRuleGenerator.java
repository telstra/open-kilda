...
public class LldpTransitRuleGenerator extends LldpRuleGenerator {

    @Builder
    public LldpTransitRuleGenerator(RuleManagerConfig config) {
        super(config);
    }
    ...
    public List<SpeakerCommandData> generateCommands(Switch sw) {
        ...
        Cookie cookie = new Cookie(LLDP_TRANSIT_COOKIE);

        return buildCommands(sw, cookie, OfTable.TRANSIT, Priority.LLDP_TRANSIT_ISL_PRIORITY, match, instructions);
    }
}
