...
/**
 * Represents get all flows northbound request.
 */
@JsonSerialize
...
@JsonPropertyOrder({
        ...
        "destination",
        "payload"})
public class FlowsStatusRequest extends CommandData {
    /**
     ...
     */
    @JsonCreator
    public FlowsStatusRequest(@JsonProperty("payload") final FlowStatusRequestPayload payload) {
        setPayload(payload);
    }
    ...
    public boolean equals(Object object) {
        ...
        FlowsStatusRequest that = (FlowsStatusRequest) object;
