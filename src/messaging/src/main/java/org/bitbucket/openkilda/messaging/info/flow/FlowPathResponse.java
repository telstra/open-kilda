...
public class FlowPathResponse extends InfoData {
    ...
    protected FlowPathResponsePayload payload;
     ...
     */
    @JsonCreator
    public FlowPathResponse(@JsonProperty("payload") final FlowPathResponsePayload payload) {
        setPayload(payload);
    }
     ...
     */
    public FlowPathResponsePayload getPayload() {
        return payload;
    }
     ...
     * @param   payload  response payload
     */
    public void setPayload(final FlowPathResponsePayload payload) {
        if (payload == null) {
