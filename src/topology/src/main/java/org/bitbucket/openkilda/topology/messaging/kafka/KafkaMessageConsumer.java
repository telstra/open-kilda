...
public class KafkaMessageConsumer {
    ...
    private static final String topic = "kilda-test";//Topic.TE_WFM_FLOW.getId()
    ...
    public void receive(final String record) {
        ...
        try {
            ...
            if (message instanceof CommandMessage) {
                ...
                if (Destination.TOPOLOGY_ENGINE.equals(data.getDestination())) {
                ...
                if (data.getDestination() == null || Destination.TOPOLOGY_ENGINE.equals(data.getDestination())) {
