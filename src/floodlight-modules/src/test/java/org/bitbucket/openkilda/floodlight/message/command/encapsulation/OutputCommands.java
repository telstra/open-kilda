...
public interface OutputCommands {
    ...
    default OFFlowAdd ingressNoneFlowMod(int inputPort, int outputPort, int transitVlan, int meterId, long cookie) {
        return ingressNoMatchVlanIdFlowMod(inputPort, outputPort, transitVlan, meterId, cookie);
    }

    default OFFlowAdd ingressPushFlowMod(int inputPort, int outputPort, int transitVlan, int meterId, long cookie) {
        return ingressNoMatchVlanIdFlowMod(inputPort, outputPort, transitVlan, meterId, cookie);
    }
    ...
    default OFFlowAdd oneSwitchNoneFlowMod(int inputPort, int outputPort, int meterId, long cookie) {
        return ofFactory.buildFlowAdd()
                .setCookie(U64.of(cookie))
                .setHardTimeout(FlowModUtils.INFINITE_TIMEOUT)
                .setIdleTimeout(FlowModUtils.INFINITE_TIMEOUT)
    ...
    default OFFlowAdd oneSwitchPopFlowMod(int inputPort, int outputPort, int inputVlan, int meterId, long cookie) {
        return ofFactory.buildFlowAdd()
                .setCookie(U64.of(cookie))
                .setHardTimeout(FlowModUtils.INFINITE_TIMEOUT)
                .setIdleTimeout(FlowModUtils.INFINITE_TIMEOUT)
    ...
    default OFFlowAdd oneSwitchPushFlowMod(int inputPort, int outputPort, int outputVlan, int meterId, long cookie) {
        return ofFactory.buildFlowAdd()
                .setCookie(U64.of(cookie))
                .setHardTimeout(FlowModUtils.INFINITE_TIMEOUT)
                .setIdleTimeout(FlowModUtils.INFINITE_TIMEOUT)
    ...
    default OFMeterMod installMeter(int bandwidth, int burstSize, int meterId) {
