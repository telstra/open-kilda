...
public abstract class BaseNeo4jBenchmark {
    @State(Scope.Benchmark)
    public static class SharedNeo4jPersistence {
        protected EmbeddedNeo4jWithFermaPersistence persistence;

        @Setup
        public void setUp() throws Exception {
            persistence = new EmbeddedNeo4jWithFermaPersistence(false);
        }
