...
public class SwitchHelper {
	...
	/** The Constant log. */
	private final Logger log = Logger.getLogger(SwitchHelper.class);
	...
	public List<PortResponseData> getSwitchPortInfoWithSwitchId(
			final List<PortDesc> portDescList, final String key,
			final List<PortModel> portModelList,
			final List<PortResponseData> portResponseDataList) {
	 ...
	 *            the port desc
	 */
	private void setPort(final String key, final List<PortModel> portModelList,
			final List<Port> portList, final PortResponseData portResponseData,
			final PortDesc portDesc) {
