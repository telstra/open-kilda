...
/**
 * The Class TopologyFlowsResponse.
 */
...
@JsonPropertyOrder({"bandwidth", "cookie", "description", "dst_port", "dst_switch", "dst_vlan",
        ...
        "transit_vlan"})
public class TopologyFlowsResponse {
    ...
    private TopologyFlowpath flowpath;
     ...
     */
    @JsonProperty("flowpath")
    public TopologyFlowpath getFlowpath() {
        return flowpath;
    }
     ...
     */
    @JsonProperty("flowpath")
    public void setFlowpath(TopologyFlowpath flowpath) {
     ...
     */
    @JsonProperty("transit_vlan")
    public void setTransitVlan(Integer transitVlan) {
