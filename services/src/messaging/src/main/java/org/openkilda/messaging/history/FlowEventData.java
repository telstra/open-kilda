...
public class FlowEventData extends HistoryData {
    ...
    public FlowEventData(
            ...
            @JsonProperty("forwardStatus") String forwardStatus,
            @JsonProperty("reverseStatus") String reverseStatus
    ) {
        super(action, taskId, details);
        this.actor = actor;
        this.flowId = flowId;
