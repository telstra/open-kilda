...
public class DumpStateVisitor {

    private DumpStateManager manager;

    public DumpStateVisitor(DumpStateManager manager) {
        this.manager = manager;
    }

    public void visit(CacheBoltState state) {
        manager.setCacheBoltState(state);
    }

    public void visit(CrudBoltState state) {
        manager.setCrudBoltState(state);
    }

    public void visit(OFELinkBoltState state) {
        manager.setOfeLinkBoltState(state);
    }

    public void visit(TransactionBoltState state) {
        manager.setTransactionBoltState(state);
    }
