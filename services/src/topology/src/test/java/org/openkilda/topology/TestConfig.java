...
package org.openkilda.topology;
...
@ComponentScan({"org.openkilda.topology.domain", "org.openkilda.topology.service"})
@PropertySource("classpath:topology.properties")
@EnableNeo4jRepositories(basePackages = {"org.openkilda.topology.domain.repository"})
public class TestConfig {
    ...
    public SessionFactory sessionFactory() {
        return new SessionFactory(configuration(), "org.openkilda.topology.domain",
                "org.openkilda.topology.domain.repository", "org.openkilda.topology.service");
    }
