...
public class LinkServiceImpl implements LinkService {
     ...
     */
    @Override
    public CompletableFuture<LinkMaxBandwidthDto> updateLinkBandwidth(LinkMaxBandwidthDto request) {
        org.openkilda.messaging.model.LinkPropsDto linkProps = linkPropsMapper.toLinkProps(request);
        LinkPropsPut teRequest = new LinkPropsPut(linkProps);
