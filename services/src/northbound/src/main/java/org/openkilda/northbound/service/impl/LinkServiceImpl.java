...
public class LinkServiceImpl implements LinkService {
    ...
    @Override
    public CompletableFuture<List<LinkDto>> updateIslUnderMaintenance(SwitchId srcSwitch, Integer srcPort,
                                                                      SwitchId dstSwitch, Integer dstPort,
        ...
        try {
            data = new UpdateIslUnderMaintenanceRequest(new NetworkEndpoint(srcSwitch, srcPort),
                    new NetworkEndpoint(dstSwitch, dstPort), underMaintenance);
