...
public abstract class SpeakerCommandReport {
    ...
    /**
     * Make human readable representation of objects. Supposed to use in logs.
     */
    public String toString() {
        ...
        if (error == null) {
            ...
            successStatus = "error=" + error.toString();
        }

        return String.format(
                "<%s{commandId=%s, %s}>", getClass().getSimpleName(), command.getCommandId(), successStatus);
    }
}
