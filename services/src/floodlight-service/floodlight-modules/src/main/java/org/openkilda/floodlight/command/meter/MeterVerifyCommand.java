...
public class MeterVerifyCommand extends AbstractMeterInstall<MeterVerifyReport> {
    ...
    @Override
    protected CompletableFuture<MeterVerifyReport> makeExecutePlan(SpeakerCommandProcessor commandProcessor)
    ...
    @Override
    protected MeterVerifyReport makeReport(Exception error) {
        return new MeterVerifyReport(this, error);
    }

    private MeterVerifyReport makeSuccessReport(MeterSchema schema) {
        return new MeterVerifyReport(this, schema);
    }
