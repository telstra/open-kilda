...
public class FloodlightDashboardLogger {
    ...
    private static final String OF_EVENT = "of-dashboard-event";
     ...
     */
    public void onPortEvent(Level level, DatapathId switchId, int portNumber, PortChangeType state) {
        Map<String, String> data = new HashMap<>();
        data.put(TAG, OF_EVENT);
        data.put(TYPE, "port");
     ...
     */
    public void onSwitchEvent(Level level, DatapathId switchId, SwitchChangeType state) {
        Map<String, String> data = new HashMap<>();
        data.put(TAG, OF_EVENT);
     ...
     * @param state a switch state.
     */
    public void onSwitchErrorEvent(Level level, String exceptionMessage, DatapathId switchId, SwitchChangeType state) {
        Map<String, String> data = new HashMap<>();
        data.put(TAG, OF_EVENT);
        data.put(TYPE, "switch");
        data.put(SWITCH_ID, switchId.toString());
