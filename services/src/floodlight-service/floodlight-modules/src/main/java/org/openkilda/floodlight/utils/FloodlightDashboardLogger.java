...
public class FloodlightDashboardLogger {
     ...
     */
    public void onPortEvent(DatapathId switchId, int portNumber, PortChangeType state) {
     ...
     */
    public void onSwitchEvent(DatapathId switchId, SwitchChangeType state) {
        Map<String, String> data = new HashMap<>();
        data.put(TAG, OF_EVENT);
     ...
     * @param state a switch state.
     */
    public void onSwitchErrorEvent(String exceptionMessage, DatapathId switchId, SwitchChangeType state) {
        Map<String, String> data = new HashMap<>();
        data.put(TAG, OF_EVENT);
        data.put(TYPE, "switch");
        data.put(SWITCH_ID, switchId.toString());
        ...
        proceed(Level.ERROR, message, data);
    }
