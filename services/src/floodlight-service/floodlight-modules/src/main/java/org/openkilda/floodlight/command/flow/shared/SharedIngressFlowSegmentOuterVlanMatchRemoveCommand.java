...
public class SharedIngressFlowSegmentOuterVlanMatchRemoveCommand
        extends SharedIngressFlowSegmentOuterVlanMatchCommand {
    public SharedIngressFlowSegmentOuterVlanMatchRemoveCommand(
            @JsonProperty("message_context") MessageContext messageContext,
            @JsonProperty("command_id") UUID commandId,
            @JsonProperty("metadata") FlowSegmentMetadata metadata,
            @JsonProperty("endpoint") FlowEndpoint endpoint) {
        super(messageContext, commandId, metadata, endpoint, OfFlowModBuilderFactory.makeFactory().actionDelete());
    }
