...
abstract class TransitFlowSegmentBlankCommand extends NotIngressFlowSegmentCommand {
    ...
    public TransitFlowSegmentBlankCommand(
            MessageContext messageContext, SwitchId switchId, UUID commandId, FlowSegmentMetadata metadata,
            Integer ingressIslPort, FlowTransitEncapsulation encapsulation, @NonNull Integer egressIslPort) {
        super(messageContext, switchId, commandId, metadata, ingressIslPort, encapsulation);
    ...
    protected OFFlowMod makeTransitModMessage() {
        ...
        return setFlowModTableId(makeFlowModBuilder(of), SwitchManager.TRANSIT_TABLE_ID)
