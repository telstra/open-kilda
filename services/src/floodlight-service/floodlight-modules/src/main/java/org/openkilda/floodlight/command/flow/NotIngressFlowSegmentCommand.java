...
public abstract class NotIngressFlowSegmentCommand extends FlowSegmentCommand {
    ...
    private void makeTransitVxLanMatch(OFFactory of, Match.Builder match) {
        // Current implementation have "optional" match by eth-src (it will require extra input data from transit
        // commands) but it have no scene, because we completely control transit traffic and only "our" VXLAN
        // encoded traffic can be on our ISL port.
