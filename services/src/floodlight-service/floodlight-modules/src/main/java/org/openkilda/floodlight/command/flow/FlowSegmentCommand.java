...
public abstract class FlowSegmentCommand extends SpeakerCommand<FlowSegmentReport> {
    ...
    protected OFFlowMod.Builder setFlowModTableId(OFFlowMod.Builder builder, int table) {
        return setFlowModTableId(builder, TableId.of(table));
    }

    protected OFFlowMod.Builder setFlowModTableId(OFFlowMod.Builder builder, TableId table) {
        if (metadata.isMultiTable()) {
            builder.setTableId(table);
        }
        return builder;
    }
