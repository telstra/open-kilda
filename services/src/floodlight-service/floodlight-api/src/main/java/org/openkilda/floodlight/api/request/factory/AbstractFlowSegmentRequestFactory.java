...
public abstract class AbstractFlowSegmentRequestFactory implements FlowSegmentRequestFactory {
    protected static UUID dummyCommandId = new UUID(0L, 0L);

    private final FlowSegmentRequest requestBlank;

    protected AbstractFlowSegmentRequestFactory(FlowSegmentRequest requestBlank) {
