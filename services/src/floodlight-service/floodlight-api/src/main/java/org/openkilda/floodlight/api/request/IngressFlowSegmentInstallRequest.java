...
public class IngressFlowSegmentInstallRequest extends IngressFlowSegmentRequest {
    @JsonCreator
    @Builder(toBuilder = true)
    public IngressFlowSegmentInstallRequest(
    ...
    public IngressFlowSegmentInstallRequest(IngressFlowSegmentRequest blank, UUID commandId) {
