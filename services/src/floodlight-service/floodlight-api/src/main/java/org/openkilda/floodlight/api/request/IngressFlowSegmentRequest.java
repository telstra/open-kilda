...
public abstract class IngressFlowSegmentRequest extends IngressFlowSegmentBase {
    ...
    protected IngressFlowSegmentRequest(
            ...
            @NonNull FlowTransitEncapsulation encapsulation, boolean cleanUpIngress) {
        super(context, commandId, metadata, endpoint, meterConfig, egressSwitchId, cleanUpIngress);
    ...
    protected IngressFlowSegmentRequest(@NonNull IngressFlowSegmentRequest other, @NonNull UUID commandId) {
        this(
                ...
                other.egressSwitchId, other.islPort, other.encapsulation, other.cleanUpIngress);
    }
}
