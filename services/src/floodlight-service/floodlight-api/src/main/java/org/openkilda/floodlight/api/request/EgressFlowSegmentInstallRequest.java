...
public class EgressFlowSegmentInstallRequest extends EgressFlowSegmentRequest {
    ...
    public EgressFlowSegmentInstallRequest(EgressFlowSegmentRequest blank, UUID commandId) {
