...
public class TransitFlowSegmentVerifyRequest extends TransitFlowSegmentBlankRequest {
    @JsonCreator
    ...
    public TransitFlowSegmentVerifyRequest(TransitFlowSegmentBlankRequest other) {
        super(other);
    }
}
