...
public class EgressFlowSegmentVerifyRequest extends EgressFlowSegmentBlankRequest {
    @JsonCreator
    ...
    public EgressFlowSegmentVerifyRequest(EgressFlowSegmentBlankRequest other) {
        super(other);
    }
}
