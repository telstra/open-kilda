...
public class OneSwitchFlowVerifyRequest extends OneSwitchFlowBlankRequest {
    @JsonCreator
    @Builder(toBuilder = true)
    public OneSwitchFlowVerifyRequest(
    ...
    public OneSwitchFlowVerifyRequest(OneSwitchFlowBlankRequest other) {
        super(other);
    }
}
