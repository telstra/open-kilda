...
public class Neo4jLinkPropsRepository extends Neo4jGenericRepository<LinkProps> implements LinkPropsRepository {
    public Neo4jLinkPropsRepository(Neo4jSessionFactory sessionFactory) {
    ...
    @Override
    public LinkProps findByEndpoints(SwitchId srcSwitch, int srcPort, SwitchId dstSwitch, int dstPort) {
