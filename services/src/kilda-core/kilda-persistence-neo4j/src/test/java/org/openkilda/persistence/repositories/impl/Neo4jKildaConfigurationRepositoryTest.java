...
public class Neo4jKildaConfigurationRepositoryTest extends Neo4jBasedTest {
    ...
    public void shouldCreateAndUpdateKildaConfiguration() {
        KildaConfiguration kildaConfiguration = kildaConfigurationRepository.find();
        ...
        KildaConfiguration foundKildaConfiguration = kildaConfigurationRepository.find();
        assertEquals(KildaConfiguration.DEFAULTS.getDefaultFlowEncapsulationType(),
                foundKildaConfiguration.getDefaultFlowEncapsulationType());

        kildaConfiguration = KildaConfiguration.builder()
                .defaultFlowEncapsulationType(FlowEncapsulationType.VXLAN)
                .build();
        kildaConfigurationRepository.createOrUpdate(kildaConfiguration);

        foundKildaConfiguration = kildaConfigurationRepository.find();
        ...
        foundKildaConfiguration = kildaConfigurationRepository.find();
        assertEquals(kildaConfiguration.getDefaultFlowEncapsulationType(),
                foundKildaConfiguration.getDefaultFlowEncapsulationType());

        kildaConfiguration = KildaConfiguration.builder()
                .defaultFlowEncapsulationType(FlowEncapsulationType.TRANSIT_VLAN)
                .build();
        kildaConfigurationRepository.createOrUpdate(kildaConfiguration);
