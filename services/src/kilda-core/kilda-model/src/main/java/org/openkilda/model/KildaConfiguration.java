...
public class KildaConfiguration {
    ...
    @NonNull
    @Property(name = "default_flow_encapsulation_type")
    @Convert(graphPropertyType = String.class)
    private FlowEncapsulationType defaultFlowEncapsulationType;

    /**
     * Constructor prevents initialization of entityId field.
     */
    @Builder(toBuilder = true)
    KildaConfiguration(FlowEncapsulationType defaultFlowEncapsulationType) {
