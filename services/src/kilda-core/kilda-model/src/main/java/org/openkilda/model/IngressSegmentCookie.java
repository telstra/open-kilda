...
public class IngressSegmentCookie extends Cookie {
    ...
    static final BitField FORWARDING_FLAG = new BitField(0x0008_0000_0000_0000L);
    static final BitField SUBTYPE_FIELD   = new BitField(0x0007_0000_0000_0000L);

    static final BitField OWN_BITS        = new BitField(0x000F_FFFF_FFF0_0000L);
