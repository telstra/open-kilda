...
public class CookieTest extends AbstractCookieTest {
    ...
    public void ensureNoChangeOutsideFieldBoundary() {
        testFieldReadWrite(new Cookie(0x0009L), 0x000BL, new Cookie.BitField(2, 1), 0x1);
        testFieldReadWrite(new Cookie(0x0000L), 0x0002L, new Cookie.BitField(2, 1), 0x1);
        testFieldReadWrite(new Cookie(0x0000L), 0x0006L, new Cookie.BitField(2, 1), 0x7, 0x3);
    }

    @Test
    public void goBeyondUpperBoundary() {
        try {
            new Cookie.BitField(2, 63);
            Assert.fail("Must raise IllegalArgumentException exception");
    ...
    public void ensureOverrideZeroBitsInsideField() {
        testFieldReadWrite(new Cookie(0x0004L), 0x000AL, new Cookie.BitField(3, 1), 0x5);
    }
