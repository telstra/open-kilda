...
package org.openkilda.atdd.staging.tests.monkeysuite.checkflows;
...
@CucumberOptions(features = {"classpath:features/monkey_suite.featuremonkey_suite.feature"},
        glue = {"org.openkilda.atdd.staging.tests.monkeysuite.checkflows", "org.openkilda.atdd.staging.steps"},
        tags = {"@CheckFlows"},
