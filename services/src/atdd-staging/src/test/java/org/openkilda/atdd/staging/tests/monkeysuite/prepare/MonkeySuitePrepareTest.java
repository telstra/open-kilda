...
package org.openkilda.atdd.staging.tests.monkeysuite.prepare;
...
@CucumberOptions(features = {"classpath:features/monkey_suite.feature"},
        glue = {"org.openkilda.atdd.staging.tests.monkeysuite.prepare", "org.openkilda.atdd.staging.steps"},
        tags = {"@Prepare"},
