...
package org.openkilda.atdd.staging.tests.monkeysuite.cleanup;
...
@CucumberOptions(features = {"classpath:features/monkey_suite.feature"},
        glue = {"org.openkilda.atdd.staging.tests.monkeysuite.cleanup", "org.openkilda.atdd.staging.steps"},
        tags = {"@Cleanup"},
