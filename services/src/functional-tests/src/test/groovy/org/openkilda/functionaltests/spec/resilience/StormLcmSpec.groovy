...
class StormLcmSpec extends BaseSpecification {
    ...
    def "System survives Storm topologies restart"() {
        ...
        flowsAmount.times {
            def flow = flowHelper.randomFlow(*topoHelper.getRandomSwitchPair(false), false, flows)
        ...
        flowHelper.updateFlow(flowToUpdate.id, flowToUpdate.tap { it.source.vlanId++ })
