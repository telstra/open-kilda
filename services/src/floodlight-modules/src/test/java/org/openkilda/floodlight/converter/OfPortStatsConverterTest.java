...
public class OfPortStatsConverterTest {
    ...
    public void testToPortStatsDataV13() {
        ...
        PortStatsData data = OfPortStatsConverter.toPostStatsData(
    ...
    private void assertPortStatsData(PortStatsData data) {
        ...
        PortStatsReply reply = data.getStats().get(0);
        assertEquals(xId, reply.getXid());
        assertEquals(1, reply.getEntries().size());

        PortStatsEntry entry = reply.getEntries().get(0);
