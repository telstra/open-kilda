...
public class OfMeterStatsConverterTest {
    ...
    public static final int meterId = 6;
    ...
    public void testToPortStatsDataV13() {
        ...
        MeterStatsReply meterStatsReply = data.getStats().get(0);
        assertEquals(xId, meterStatsReply.getXid());
        assertEquals(1, meterStatsReply.getEntries().size());

        MeterStatsEntry statsEntry = meterStatsReply.getEntries().get(0);
