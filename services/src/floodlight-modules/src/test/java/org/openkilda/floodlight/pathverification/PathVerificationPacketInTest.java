...
public class PathVerificationPacketInTest extends FloodlightTestCase {
    ...
    protected IPacket getPacket() {
        ...
        VerificationPacket verificationPacket = VerificationPacket.builder()
                .chassisId(new LLDPTLV().setType((byte) 1).setLength((short) 7)
                        .setValue(new byte[] {0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01}))
                .portId(new LLDPTLV().setType((byte) 2).setLength((short) 3)
                        .setValue(new byte[] {0x02, 0x00, 0x01}))
                .ttl(new LLDPTLV().setType((byte) 3).setLength((short) 2)
