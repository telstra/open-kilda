...
final class ErrorMessageBuilder {
    ...
    /**
     * Sets the destination and returns a reference to this Builder so that the methods can be chained together.
     *
     * @param destination the destination to set
     * @return a reference to this Builder
     */
    ErrorMessageBuilder withDestination(Destination destination) {
    ...
    void sendVia(IKafkaProducerService producerService) {
        ...
        ErrorMessage error = new ErrorMessage(errorData, System.currentTimeMillis(), correlationId, destination);
