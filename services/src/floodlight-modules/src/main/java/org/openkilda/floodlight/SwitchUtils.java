...
public class SwitchUtils {
    ...
    /**
     * Locate {@link IOFSwitch} object by provided {@link DatapathId}.
     *
     * @param dpId {@link DatapathId} switch it
     * @return {@link IOFSwitch} target switch
     * @throws IllegalArgumentException if switch not found
     */
