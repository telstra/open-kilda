...
public abstract class ExclusionInfoData extends InfoAppData {
    ...
    public ExclusionInfoData(String flowId, Endpoint endpoint, String application, Exclusion exclusion,
                             Boolean success) {
