...
public class LinkEnableBfdDto {

    @JsonProperty(value = "src_switch", required = true)
    private String srcSwitch;

    @JsonProperty(value = "src_port", required = true)
    private Integer srcPort;

    @JsonProperty(value = "dst_switch", required = true)
    private String dstSwitch;

    @JsonProperty(value = "dst_port", required = true)
    private Integer dstPort;

    @JsonProperty("enable_bfd")
    private boolean enableBfd;

    public LinkEnableBfdDto(@JsonProperty(value = "src_switch", required = true) String srcSwitch,
