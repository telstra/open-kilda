...
public class KafkaConfig {
    ...
    public Properties kafkaProperties(@Value("${kafka.bootstrap.server}") String bootstrapServer) {
        Properties connectDefaults = new Properties();
        connectDefaults.put("bootstrap.servers", bootstrapServer);
        connectDefaults.put("client.id", "autotest");
