...
package org.openkilda.testlib.config;

import org.openkilda.testlib.tools.LoggingRequestInterceptor;
...
@ComponentScan(basePackages = {"org.openkilda.testlib.service"})
