    ...
    public static class SwitchFsmFactory {
        ...
        SwitchFsmFactory() {
            ...
            builder.internalTransition()
                    .within(SwitchFsmState.SYNCHRONIZE).on(SwitchFsmEvent.RECEIVED_SYNC_ERROR)
                    .callMethod("switchSynchronizedError");
            builder.internalTransition()
                    .within(SwitchFsmState.SYNCHRONIZE).on(SwitchFsmEvent.RECEIVED_SYNC_TIMEOUT)
