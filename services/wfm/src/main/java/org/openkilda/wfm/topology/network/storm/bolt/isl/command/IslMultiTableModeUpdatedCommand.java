...
public class IslMultiTableModeUpdatedCommand extends IslCommand {

    private final MultiTableModeUpdated payload;

    public IslMultiTableModeUpdatedCommand(MultiTableModeUpdated payload) {
    ...
    public void apply(IslHandler handler) {
        handler.processMultiTableModeUpdate(getReference(), getEndpoint());
