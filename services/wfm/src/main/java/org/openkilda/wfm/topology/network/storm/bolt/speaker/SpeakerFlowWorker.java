...
@Slf4j
public class SpeakerFlowWorker extends WorkerBolt {
    public static final String BOLT_ID = WorkerBolt.ID + ".speaker.flow";

    public static final String FIELD_ID_PAYLOAD = SpeakerFlowEncoder.FIELD_ID_PAYLOAD;
    public static final String FIELD_ID_KEY = SpeakerFlowEncoder.FIELD_ID_KEY;
    ...
    public SpeakerFlowWorker(Config config) {
        super(config);
    }
    ...
    private void handleCommand(Tuple input, String field) throws PipelineException {
        SpeakerFlowWorkerCommand command = pullValue(input, field, SpeakerFlowWorkerCommand.class);
        command.apply(this);
    }
