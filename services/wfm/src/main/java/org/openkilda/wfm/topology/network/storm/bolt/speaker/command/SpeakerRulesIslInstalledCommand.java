...
public class SpeakerRulesIslInstalledCommand extends SpeakerRulesWorkerCommand {
    InstallIslDefaultRulesResult payload;

    public SpeakerRulesIslInstalledCommand(String key, InstallIslDefaultRulesResult payload) {
        super(key);
