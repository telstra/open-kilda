...
public class NotificationsEncoder extends KafkaEncoder {
    ...
    private AppData pullAppPayload(Tuple input) throws PipelineException {
        return pullValue(input, FIELD_ID_PAYLOAD, AppData.class);
    }

    private AppMessage wrap(CommandContext commandContext, AppData payload) {
