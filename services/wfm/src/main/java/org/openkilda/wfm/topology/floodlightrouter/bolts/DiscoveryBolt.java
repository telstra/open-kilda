...
public class DiscoveryBolt extends AbstractTickStatefulBolt<InMemoryKeyValueState<String, RouterService>>
    ...
    @Override
    public void emitConsumerMessage(Message message) {
        emitConsumerMessage(pullKeyFromCurrentTuple(), message);
    }

    @Override
    public void emitConsumerMessage(String key, Message message) {
