...
import org.openkilda.wfm.topology.switchmanager.bolt.SwitchManager;
...
public class SwitchManagerTopology extends AbstractTopology<SwitchManagerTopologyConfig> {
    ...
    public StormTopology createTopology() {
        ...
        builder.setBolt(CoordinatorBolt.ID, new CoordinatorBolt())
                ...
                .fieldsGrouping(SwitchManager.ID, CoordinatorBolt.INCOME_STREAM, FIELDS_KEY);
        ...
        builder.setBolt(RouterBolt.ID, new RouterBolt())
                ...
                .fieldsGrouping(SwitchManager.ID, RouterBolt.INCOME_STREAM, FIELDS_KEY);

        builder.setBolt(SwitchManager.ID, new SwitchManager(RouterBolt.ID, persistenceManager,
                topologyConfig.getOperationTimeout(),
                ...
                .fieldsGrouping(RouterBolt.ID, SwitchManager.INCOME_STREAM, FIELDS_KEY)
                .directGrouping(CoordinatorBolt.ID);

        builder.setBolt(NB_KAFKA_BOLT, buildKafkaBolt(topologyConfig.getKafkaNorthboundTopic()))
                .shuffleGrouping(SwitchManager.ID, StreamType.TO_NORTHBOUND.toString());

        builder.setBolt(SPEAKER_KAFKA_BOLT, buildKafkaBolt(topologyConfig.getKafkaSpeakerTopic()))
                .shuffleGrouping(SwitchManager.ID, StreamType.TO_FLOODLIGHT.toString());
