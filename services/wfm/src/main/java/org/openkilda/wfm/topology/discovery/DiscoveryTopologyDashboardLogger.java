...
import org.openkilda.wfm.topology.discovery.controller.sw.AbstractPort;
...
public class DiscoveryTopologyDashboardLogger extends AbstractLogWrapper {
     ...
     */
    public void onPortAdd(Level level, SwitchId switchId, AbstractPort port) {
        String portType = port.toString().toLowerCase().contains("bdf") ? "logical" : "physical";
        ...
        data.put(STATE, "add");
        data.put(PORT_TYPE, portType);
        proceed(level, String.format("Add port %d on switch %s", port.getPortNumber(), switchId), data);
    }
     ...
     * @param port a port number.
     */
    public void onPortDelete(Level level, SwitchId switchId, AbstractPort port) {
        String portType = port.toString().toLowerCase().contains("bdf") ? "logical" : "physical";
        Map<String, String> data = new HashMap<>();
        data.put(TAG, "switch-port-isl");
        data.put(TYPE, PORT);
        ...
        data.put(PORT_TYPE, portType);
        proceed(level, String.format("Delete port %d on switch %s", port.getPortNumber(), switchId), data);
    }
     ...
     */
    public void onUpdatePortStatus(Level level, SwitchId switchId, int port, LinkStatus linkStatus) {
        Map<String, String> data = new HashMap<>();
        data.put(TAG, "switch-port-isl");
        data.put(TYPE, PORT);
        data.put(SWITCH_ID, switchId.toString());
     ...
     */
    public void onIslUpdateStatus(Level level, IslReference ref, String state) {
        Map<String, String> data = new HashMap<>();
        data.put(TAG, "switch-port-isl");
        data.put(TYPE, "isl");
        ...
        proceed(level, String.format("ISL changed status to: %s", state), data);
    }
     ...
     */
    public void onSwitchUpdateStatus(Level level, SwitchId switchId, String state) {
        Map<String, String> data = new HashMap<>();
        data.put(TAG, "switch-port-isl");
        data.put(TYPE, "switch");
        data.put(SWITCH_ID, switchId.toString());
        data.put(STATE, state);
        proceed(level, String.format("Switch '%s' change status to '%s'", switchId, state), data);
    }
     ...
     * @param switchId a switch ID.
     */
    public void onSwitchAdd(Level level, SwitchId switchId) {
        Map<String, String> data = new HashMap<>();
        data.put(TAG, "switch-port-isl");
        data.put(TYPE, "switch");
        data.put(SWITCH_ID, switchId.toString());
        data.put(STATE, "add");
        proceed(level, String.format("Switch '%s' connected", switchId), data);
    }
     ...
     * @param switchId a switch ID.
     */
    public void onSwitchDelete(Level level, SwitchId switchId) {
        Map<String, String> data = new HashMap<>();
        data.put(TAG, "switch-port-isl");
        data.put(TYPE, "switch");
        data.put(SWITCH_ID, switchId.toString());
        data.put(STATE, "delete");
        proceed(level, String.format("Switch '%s' has been deleted", switchId), data);
    }
}
