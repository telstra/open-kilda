...
@Slf4j
public class ConsiderNonIngressRuleValidateResultAction extends SegmentValidateResultAction {
    ...
    protected void onComplete(FlowCreateFsm fsm) {
        saveHistory(
                fsm, fsm.getCarrier(), fsm.getFlowId(), "Not ingress segments validation have been completed",
