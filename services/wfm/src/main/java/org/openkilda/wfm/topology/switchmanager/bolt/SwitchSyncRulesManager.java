...
public class SwitchSyncRulesManager extends HubBolt implements SwitchCommandCarrier {
    public static final String ID = "switch.manager.bolt";

    private final PersistenceManager persistenceManager;
    private transient SyncRulesService service;

    public SwitchSyncRulesManager(String requestSenderComponent, int timeoutMs, boolean autoAck,
