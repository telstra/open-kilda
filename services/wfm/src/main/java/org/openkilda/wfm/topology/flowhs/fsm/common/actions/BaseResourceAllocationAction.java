...
public abstract class BaseResourceAllocationAction<T extends FlowPathSwappingFsm<T, S, E, C>, S, E, C> extends
    ...
    protected FlowResources getResources(Flow flow, FlowPath forwardPath, FlowPath reversePath) {
        ...
        return FlowResources.builder()
                ...
                .forward(FlowResources.PathResources.builder()
                        .pathId(forwardPath.getPathId())
                        .meterId(forwardPath.getMeterId())
                        .encapsulationResources(encapsulationResources)
                        .build())
                .reverse(FlowResources.PathResources.builder()
    ...
    protected FlowPath extractPath(Flow flow, FlowPathSnapshot pathSnapshot, FlowPath fallback) {
        ...
        if (pathSnapshot != null) {
            flow.getPath(pathSnapshot.getPath().getPathId());
        }
