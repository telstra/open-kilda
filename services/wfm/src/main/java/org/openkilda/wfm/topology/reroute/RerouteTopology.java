...
public class RerouteTopology extends AbstractTopology<RerouteTopologyConfig> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RerouteTopology.class);
    ...
    public StormTopology createTopology() {
        ...
        KafkaSpout kafkaSpout = createKafkaSpout(topologyConfig.getKafkaTopoRerouteTopic(), SPOUT_ID_REROUTE);
        ...
        topologyBuilder.setBolt(BOLT_ID_REROUTE_THROTTLING, flowThrottlingBolt, newParallelism)
                .fieldsGrouping(BOLT_ID_REROUTE, StreamType.WFM_REROUTE.toString(),
