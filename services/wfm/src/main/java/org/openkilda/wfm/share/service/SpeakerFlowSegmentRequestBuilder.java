...
public class SpeakerFlowSegmentRequestBuilder implements FlowCommandBuilder {
    ...
    private List<FlowSegmentRequestFactory> makeAll(
    ...
    private List<FlowSegmentRequestFactory> makeAllExceptionIngress(
            CommandContext context, FlowPath pathAtoZ, FlowPath pathZtoA) {
        List<FlowSegmentRequestFactory> requests = new ArrayList<>();
        requests.addAll(makeRequests(
    ...
    private List<FlowSegmentRequestFactory> makeIngressOnly(
            CommandContext context, FlowPath pathAtoZ, FlowPath pathZtoA) {
        List<FlowSegmentRequestFactory> requests = new ArrayList<>();
        requests.addAll(makeRequests(
