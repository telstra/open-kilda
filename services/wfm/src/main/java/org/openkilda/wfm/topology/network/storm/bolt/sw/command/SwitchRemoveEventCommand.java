...
public class SwitchRemoveEventCommand extends SwitchCommand {

    public SwitchRemoveEventCommand(DeactivateSwitchInfoData payload) {
        super(payload.getSwitchId());
    }

    @Override
    public void apply(SwitchHandler handler) {
        handler.processRemoveSwitch(getDatapath());
    }
}
