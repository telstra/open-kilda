...
public class PortReportFsm
    ...
    public static PortReportFsm create(Endpoint endpoint) {
        return builder.newStateMachine(PortFsm.PortFsmState.INIT, endpoint);
    }

    public PortReportFsm(Endpoint endpoint) {
