...
public class FlowOperationsDashboardLogger extends AbstractLogWrapper {
    ...
    private static final String FLOW_CUD_EVENT = "flow_cud";
    private static final String FLOW_READ_EVENT = "flow_read";
    private static final String PATH_UPDATE_EVENT = "path_update";
    ...
    public void onFlowCreate(Flow flow) {
        ...
        data.put(EVENT_TYPE, FLOW_CUD_EVENT);
    ...
    public void onFlowPathsSwap(Flow flow) {
        ...
        data.put(FLOW_ID, flow.getFlowId());
        data.put(EVENT_TYPE, PATH_UPDATE_EVENT);
    ...
    public static class Builder {
        public FlowOperationsDashboardLogger build(Logger logger) {
            return new FlowOperationsDashboardLogger(logger);
        }
    }
}
