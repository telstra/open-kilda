...
abstract class CoordinatedBolt extends AbstractBolt implements TimeoutCallback {
     ...
     */
    protected void registerCallback(String key, CommandContext context) {
        registerCallback(key, context, defaultTimeout);
    }
     ...
     */
    protected void registerCallback(String key, CommandContext context, int timeout) {
        getOutput().emit(CoordinatorBolt.INCOME_STREAM, new Values(
