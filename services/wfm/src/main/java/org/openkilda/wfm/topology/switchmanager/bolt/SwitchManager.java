...
public class SwitchManager extends HubBolt implements SwitchSyncRulesCarrier {
    public static final String ID = "switch.manager.bolt";

    private final PersistenceManager persistenceManager;
    private transient SyncRulesService service;

    public SwitchManager(String requestSenderComponent, int timeoutMs, boolean autoAck,
    ...
    public void prepare(Map stormConf, TopologyContext context, OutputCollector collector) {
        ...
        service = new SyncRulesServiceImpl(this);
    }
    ...
    @Override
    public void dumpRules(String key, CommandMessage command) {
        getOutput().emit(StreamType.TO_FLOODLIGHT.toString(), new Values(key, command));
    }

    @Override
    public void installRules(String key, CommandMessage command) {
        getOutput().emit(StreamType.TO_FLOODLIGHT.toString(), new Values(key, command));
    }
