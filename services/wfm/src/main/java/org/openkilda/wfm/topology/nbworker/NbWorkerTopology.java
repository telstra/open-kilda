...
import org.openkilda.wfm.topology.nbworker.bolts.ValidationOperationsBolt;
...
public class NbWorkerTopology extends AbstractTopology<NbWorkerTopologyConfig> {
    ...
    private static final String VALIDATION_BOLT_NAME = "validation-operations-bolt";
    ...
    public StormTopology createTopology() {
        ...
        ValidationOperationsBolt validationBolt = new ValidationOperationsBolt(persistenceManager);
        tb.setBolt(VALIDATION_BOLT_NAME, validationBolt, parallelism)
    ...
    /**
     * Uploads NbWorker topology into storm.
     *
