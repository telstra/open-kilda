...
/**
 * Storm topology to read data from database. Topology design: kilda.topo.nb-spout ---> router-bolt --->
 * switches-operations-bolt ---> response-splitter-bolt ---> nb-kafka-bolt | ---> links-operations-bolt    ---> | | --->
