...
public class DiscoveryOptions implements Serializable {
    ...
    public DiscoveryOptions(DiscoveryTopologyConfig topologyConfig) {
        ...
        delayWarmUp = topologyConfig.getPortUpDownThrottlingDelaySecondsWarmUp();
        delayCoolingDown = topologyConfig.getPortUpDownThrottlingDelaySecondsCoolDown();
        delayMin = topologyConfig.getPortUpDownThrottlingDelaySecondsMin();
    }
}
