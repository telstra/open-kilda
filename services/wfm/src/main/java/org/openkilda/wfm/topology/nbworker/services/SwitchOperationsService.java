...
public class SwitchOperationsService {
    ...
    public void checkSwitchHasNoFlows(SwitchId switchId) throws IllegalSwitchStateException {
        Set<String> flowIds = flowRepository.findFlowIdsWithSwitchInPath(switchId);
    ...
    public void checkSwitchHasNoFlowSegments(SwitchId switchId) throws IllegalSwitchStateException {
        Collection<FlowPath> outgoingFlowPaths = flowPathRepository.findBySegmentSrcSwitch(switchId);
        Collection<FlowPath> ingoingFlowPaths = flowPathRepository.findBySegmentDestSwitch(switchId);
