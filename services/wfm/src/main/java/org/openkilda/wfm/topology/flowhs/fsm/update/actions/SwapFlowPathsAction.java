...
public class SwapFlowPathsAction extends FlowProcessingAction<FlowUpdateFsm, State, Event, FlowUpdateContext> {
    ...
    protected void perform(State from, State to, Event event, FlowUpdateContext context, FlowUpdateFsm stateMachine) {
        persistenceManager.getTransactionManager().doInTransaction(() -> {
            ...
            flowPathRepository.updateStatus(originalFlow.getForwardPathId(), FlowPathStatus.IN_PROGRESS);
            ...
            FlowEncapsulationType oldFlowEncapsulationType = stateMachine.getOriginalFlow().getEncapsulationType();
