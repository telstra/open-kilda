...
public class ValidationOperationsBolt extends AbstractBolt {
    ...
    public ValidationOperationsBolt(PersistenceManager persistenceManager) {
    ...
    protected void handleInput(Tuple input) throws PipelineException {
        ...
        ValidationService validationService = new ValidationService(request, repositoryFactory);
        getOutput().emit(input, new Values(ImmutableList.of(validationService.validate()), correlationId));
    }
}
