...
public class FlowService extends BaseFlowService {
     ...
     * @return the created flow with the forward path and resources set.
     */
    public UnidirectionalFlow createFlow(Flow flow, String diverseFlowId, FlowCommandSender sender)
        ...
        return buildForwardUnidirectionalFlow(result.getForward());
    }
     ...
     */
    public UnidirectionalFlow updateFlow(Flow updatingFlow, String diverseFlowId, FlowCommandSender sender)
