 ...
 */
public class MultiPrefixConfigurationProvider extends ValidatingConfigurationProvider {
    public MultiPrefixConfigurationProvider(Properties payload, String... prefixes) {
