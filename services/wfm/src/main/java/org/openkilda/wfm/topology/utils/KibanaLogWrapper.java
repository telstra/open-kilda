...
/**
 * The KIBANA dashboard log manager.
 */
@Slf4j
public class KibanaLogWrapper {
    ...
    /**
     * Switch discovery dashboard log.
     *
    ...
    /**
     * ISL Discovery log when loop detected.
     *
    ...
    /**
     * ISL Discovery log when state changed.
     *
     * @param srcSwitch a source switch id.
     * @param srcPort a source port id.
     * @param dstPort a destination port id.
