...
public class DiscoveryTopologyLogWrapper extends AbstractLogWrapper {
    ...
    public DiscoveryTopologyLogWrapper(Logger logger) {
        super(logger);
    }
     ...
     */
    public void onUpdateOnlineStatus(Level level, String message, SwitchId switchId, int port, String state) {
        Map<String, String> data = new HashMap<>();
