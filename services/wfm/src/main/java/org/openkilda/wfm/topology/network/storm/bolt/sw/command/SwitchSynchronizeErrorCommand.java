...
public class SwitchSynchronizeErrorCommand extends SwitchCommand {

    private SwitchSyncErrorData payload;

    public SwitchSynchronizeErrorCommand(SwitchSyncErrorData payload) {
    ...
    public void apply(SwitchHandler handler) {
        handler.processSwitchManagerErrorResponse(payload);
    }
}
