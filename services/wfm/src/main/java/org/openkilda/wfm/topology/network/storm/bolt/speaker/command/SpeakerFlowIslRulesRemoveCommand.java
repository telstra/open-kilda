...
public class SpeakerFlowIslRulesRemoveCommand extends SpeakerFlowWorkerCommand {
    Endpoint source;
    Endpoint destination;

    public SpeakerFlowIslRulesRemoveCommand(String key, Endpoint source, Endpoint destination) {
        super(key);
        this.source = source;
