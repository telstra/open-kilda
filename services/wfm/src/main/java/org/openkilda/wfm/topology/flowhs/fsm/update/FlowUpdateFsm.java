...
public final class FlowUpdateFsm extends FlowPathSwappingFsm<FlowUpdateFsm, State, Event, FlowUpdateContext> {
    ...
    public void setTargetFlow(RequestedFlow targetFlow) {
        this.targetFlow = targetFlow;
        if (targetFlow.getFlowEncapsulationType() != null) {
            setNewEncapsulationType(targetFlow.getFlowEncapsulationType());
        }
    }

    public void setOriginalFlow(RequestedFlow originalFlow) {
        this.originalFlow = originalFlow;
        setOriginalEncapsulationType(originalFlow.getFlowEncapsulationType());
    }
