...
public class HistoryService {
    ...
    public List<PortHistory> listPortHistory(SwitchId switchId, int portNumber) {
        return new ArrayList<>(portHistoryRepository.findBySwitchIdAndPortNumber(switchId, portNumber));
    }
}
