...
public class RouterBolt extends AbstractBolt {
    ...
    private void handleOneWayLatency(Tuple input, IslOneWayLatency data, long timestamp) {
        ...
        Values values = new Values(islReference, data, timestamp, getCommandContext());
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        Fields oneWayLatencyFields = new Fields(
                ISL_GROUPING_FIELD, LATENCY_DATA_FIELD, TIMESTAMP_FIELD, FIELD_ID_CONTEXT);
