...
public class IslMapperTest {
    ...
    public void islMapperTest() {
        ...
        path.add(new PathNode(TEST_SWITCH_A_ID, 1, 0));
        path.add(new PathNode(TEST_SWITCH_B_ID, 1, 0));
        IslInfoData islInfoData = new IslInfoData(1, path, 2, IslChangeType.DISCOVERED, 4);
