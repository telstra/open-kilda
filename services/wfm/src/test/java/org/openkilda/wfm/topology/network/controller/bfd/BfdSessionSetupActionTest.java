...
public class BfdSessionSetupActionTest extends AbstractActionTest {
    @Mock
    ...
    public void happyPathResponseUp() {
        ...
        Action action = makeAction(requestKey);
        ...
        // link become UP
        Action.ActionResult result = action.updateLinkStatus(LinkStatus.UP)
    ...
    public void happyPathUpResponse() {
        ...
        // speaker response
        BfdSessionResponse response = new BfdSessionResponse(payload, null);
        Action.ActionResult result = action.consumeSpeakerResponse(requestKey, response)
                .orElseThrow(expectResultError);
        Assert.assertTrue(result.isSuccess());
    }
    ...
    protected Action makeAction(String requestKey) {
        ...
        final Action action = new BfdSessionSetupAction(carrier, payload);
