...
public class StatsTopologyTest extends StableAbstractStormTest {
    ...
    private final int meterId = 567; // meter id for not default rule
    ...
    private void runMeterStatsTest(int meterId, SwitchId switchId, Consumer<Datapoint> assertConsumer)
            throws JsonProcessingException {
        MeterStatsEntry entry = new MeterStatsEntry(meterId, 5, 6);
        MeterStatsReply reply = new MeterStatsReply(3, Collections.singletonList(entry));
        MeterStatsData data = new MeterStatsData(switchId, Collections.singletonList(reply));
