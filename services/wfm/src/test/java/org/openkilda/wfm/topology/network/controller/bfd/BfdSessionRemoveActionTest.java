...
public class BfdSessionRemoveActionTest extends AbstractBfdActionTest {
    @Mock
    ...
    public void happyPathResponseDown() {
        ...
        BfdAction action = makeAction(requestKey, LinkStatus.UP);
    ...
    public void happyPathUpResponseDown() {
        String requestKey = "request-key";
        BfdAction action = makeAction(requestKey, LinkStatus.DOWN);
    ...
    private BfdAction makeAction(String requestKey, LinkStatus linkStatus) {
        when(carrier.removeBfdSession(any(NoviBfdSession.class))).thenReturn(requestKey);

        BfdAction action = new BfdSessionRemoveAction(carrier, payload, linkStatus);
