...
public class LinkOperationsServiceTest extends Neo4jBasedTest {
    ...
    @Test
    public void shouldUpdateIslUnderMaintenanceFlagAndChangeCost() throws IslNotFoundException {
        createIsl();

        for (int i = 0; i < 2; i++) {
            List<Isl> link = linkOperationsService
                    .updateIslUnderMaintenanceFlag(TEST_SWITCH_A_ID, TEST_SWITCH_A_PORT,
