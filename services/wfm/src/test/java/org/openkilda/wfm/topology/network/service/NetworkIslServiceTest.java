...
public class NetworkIslServiceTest {
    ...
    public void considerLinkPropsDataOnCreate() {
        ...
        IslReference reference = new IslReference(endpointAlpha1, endpointBeta2);
        service.islUp(endpointAlpha1, reference, new IslDataHolder(200L, 20, 200L));

        mockPersistenceIsl(endpointAlpha1, endpointBeta2, islAlphaBeta);
        mockPersistenceIsl(endpointBeta2, endpointAlpha1, islBetaAlpha);
        service.islUp(endpointBeta2, reference, new IslDataHolder(200L, 20, 200L));
    ...
    public void considerLinkPropsDataOnRediscovery() {
        ...
        IslReference reference = new IslReference(endpointAlpha1, endpointBeta2);
        service.islUp(endpointAlpha1, reference, new IslDataHolder(300L, 20, 300L));

        mockPersistenceIsl(endpointAlpha1, endpointBeta2, islAlphaBeta);
        mockPersistenceIsl(endpointBeta2, endpointAlpha1, islBetaAlpha);
        service.islUp(endpointBeta2, reference, new IslDataHolder(300L, 20, 300L));

        verifyIslBandwidthUpdate(300L, 300L);

        // fail (half)
        service.islDown(endpointAlpha1, reference, false);
        service.islDown(endpointBeta2, reference, false);
