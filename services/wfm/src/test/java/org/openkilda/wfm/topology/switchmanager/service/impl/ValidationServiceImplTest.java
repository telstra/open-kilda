...
public class ValidationServiceImplTest {
    ...
    private static final long FLOW_METER_MIN_BURST_SIZE_IN_KBITS = 1024;
    private static final double FLOW_METER_BURST_COEFFICIENT = 1.05;
    ...
    public void validateMetersEmpty() {
        ...
        ValidateMetersResult response = validationService.validateMeters(SWITCH_ID_A, new ArrayList<>(),
                FLOW_METER_MIN_BURST_SIZE_IN_KBITS, FLOW_METER_BURST_COEFFICIENT);
    ...
    public void validateMetersMissingAndExcessMeters() {
        ...
        assertEquals(33L, (long) response.getExcessMeters().get(0));
    }
