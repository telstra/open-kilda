...
public class FlowCommandRegistryTest {
    ...
    private static final BaseFlow FLOW_COMMAND_1 = new BaseFlow(UUID.randomUUID(), TEST_FLOW, 0L, SWITCH_ID_1);
    private static final BaseFlow FLOW_COMMAND_2 = new BaseFlow(UUID.randomUUID(), TEST_FLOW, 0L, SWITCH_ID_1);
    ...
    public void failToRegisterTransactionWithWrongFlowId() {
        ...
        List<List<BaseFlow>> groups = asList(singletonList(FLOW_COMMAND_1), singletonList(FLOW_COMMAND_2));
