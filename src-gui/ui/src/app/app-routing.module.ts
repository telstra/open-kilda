...
import {SwitchDetailComponent, SwitchesComponent, SwitchLayoutComponent} from './modules/switches';
import {FlowAddComponent, FlowComponent, FlowDetailComponent, FlowEditComponent, FlowLayoutComponent} from './modules/flows';
