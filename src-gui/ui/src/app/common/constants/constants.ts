export const MessageObj = {
    ...
    updating_isl_description: 'Updating ISL description',
    isl_description_updated: 'ISL description updated successfully!',
    error_isl_description_updated: 'Error in updating ISL description!',
