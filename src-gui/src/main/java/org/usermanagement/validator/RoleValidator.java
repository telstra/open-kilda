...
public class RoleValidator {
    ...
    public void validateRole(final Role role) {
        ...
        if (ValidatorUtil.isNull(role.getName())) {
            log.warn("Validation fail for role(name: " + role.getName() + "). Error: "
    ...
    public void validateUpdateRole(final Role role, Long roleId) {
        ...
        if (ValidatorUtil.isNull(roleId)) {
            log.warn("Validation fail for role(role_id: " + roleId + "). Error: "
            ...
            log.warn("Validation fail for role(name, status, description and permissions: " + role.getName() + ","
