...
* TYPE_FIELD one of {
  ...
  ISL_VLAN_EGRESS_RULES(0x002),
  ISL_VXLAN_EGRESS_RULES(0x003),
  ISL_VXLAN_TRANSIT_RULES(0x004),
  INGRESS_RULES(0x005),
...
| `0x8000_0000_0000_0008` | `PRE_INGRESS_PASS_THROUGH`                | Sends packets from the pre-ingress table to the ingress table.                                                                                                                                                                                                           |
| `0x8000_0000_0000_0009` | `INGRESS_DROP`                            | Drops uncaught packets in the ingress table.                                                                                                                                                                                                                             |
| `0x8000_0000_0000_000A` | `POST_INGRESS_DROP`                       | Drops uncaught packets in the post-ingress table.                                                                                                                                                                                                                        |
| `0x8000_0000_0000_000B` | `EGRESS_PASS_THROUGH`                     | Sends packets from egress table to the transit table.                                                                                                                                                                                                                    |
| `0x8000_0000_0000_000C` | `TRANSIT_DROP`                            | Drops uncaught packets in the transit table.                                                                                                                                                                                                                             |
...
| `0x8020_0000_XXXX_XXXX` | `ISL_VLAN_EGRESS`                         | Moves VLAN packets received from an ISL port XXX from the input table to the egress table.                                                                                                                                                                               |
| `0x8030_0000_XXXX_XXXX` | `ISL_VXLAN_EGRESS`                        | Moves VXLAN packets received from an ISL port XXX from the input table to the egress table.                                                                                                                                                                              |
| `0x8040_0000_XXXX_XXXX` | `ISL_VXLAN_TRANSIT`                       | Moves VXLAN packets received from an ISL port XXX from the input table to the transit table.                                                                                                                                                                             |
| `0x8050_0000_XXXX_XXXX` | `INGRESS_RULES`                           | Moves packets received from Customer port XXX from the input table to the re-ingress table.                                                                                                                                                                              |
...
| `0x80F0_0000_XXXX_XXXX` | `INPUT_PING`                              | Copies the functionality of ISL_VLAN_EGRESS but adding a new match entry (ETH_SRC=ping_magic_mac_address) and sends the packet directly to the transit table.                                                                                                            |
